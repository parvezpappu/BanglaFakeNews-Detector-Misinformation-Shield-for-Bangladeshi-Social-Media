...
LGBM_MODEL_REPO_ID = os.getenv("LGBM_MODEL_REPO_ID", MODEL_NAME)
LGBM_MODEL_FILENAME = os.getenv("LGBM_MODEL_FILENAME", "lightgbm_model.joblib")
LGBM_MODEL_SUBFOLDER = os.getenv("LGBM_MODEL_SUBFOLDER", MODEL_SUBFOLDER)
